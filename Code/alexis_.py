...
filepath = '/content/drive/MyDrive/Github/RL_internship/Figures & their data/'

df_ratings = pd.read_csv(filepath+"ratings.csv", header=None)
...
df = pd.read_csv(filepath+'listens_exp1_independent.csv', header=None)
